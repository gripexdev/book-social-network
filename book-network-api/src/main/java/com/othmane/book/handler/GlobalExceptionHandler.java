package com.othmane.book.handler;
...
import static com.othmane.book.handler.BusinessErrorCodes.BAD_CREDENTIALS;
...
public class GlobalExceptionHandler {
    ...
    // any type of exception that is not handled in our application
    @ExceptionHandler(Exception.class)
    public ResponseEntity<ExceptionResponse> handleException(Exception exp) {
        // log the exception for dev purposes
        exp.printStackTrace();
